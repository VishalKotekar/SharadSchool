...
def default_site_config(apps, schema_editor):
    ...
    User.objects.create_superuser("Admin", "vishalkotekar0096@gmail.com", "Vishu@7972")

    Config = apps.get_model("corecode", "SiteConfig")
    Config.objects.bulk_create(
        [
            Config(key="school_name", value="Sharad School"),
            Config(key="school_slogan", value="A great school"),
            Config(key="school_address", value="Ichalkaranji, Nigeria"),
        ]
    )
